...
class EditablePopup extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      nametag:
        this.props.nametag || this.thePopup.leafletElement._source.nametag,
    });
  }

  parsedChildren = this.props.children.$$typeof
  ...
  render() {
    ...
    if (this.props.removable && !this.props.editable) {
      Buttons = (
        <div className="leaflet-popup-useraction-buttons">
          <button className={`${prefix} remove`} onClick={this.removeSource}>
      ...
      Buttons = (
        <div className="leaflet-popup-useraction-buttons">
          <button className={`${prefix} edit`} onClick={this.openEditScreen}>
            Edit
          </button>
        </div>
      );
      ...
      Buttons = (
        <div className="leaflet-popup-useraction-buttons">
          ...
          <button onClick={this.openEditScreen} className={`${prefix} edit`}>
            Edit
          </button>
        </div>
      );
    ...
    const editScreen = (
      <React.Fragment>
        ...
        <div className="leaflet-popup-useraction-buttons">
          <button className={`${prefix} cancel`} onClick={this.cancelEdits}>
            Cancel
          </button>
